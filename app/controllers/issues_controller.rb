  ...
  def index
    ...
    if @query.valid?
      ...
      if params[:format]=='xls'
        ...
        sheet1.column(0).width=16
        sheet1.column(5).width= 14

        header_row[0] = l(:gongcheng)
        header_row[1] = l(:qiantouren)
        header_row[2] = l(:duban)
        header_row[3] = l(:dubanDeadline)
        header_row[4] = l(:renwubianhao)
        header_row[5] = l(:renwu)
        header_row[6] = l(:fuzeren)
        header_row[7] = l(:pingtai)
        header_row[8] = l(:pingtaifenlei)      
        header_row[9] = l(:yewubumen)
        header_row[10] = l(:shishituandui)
        header_row[11] = l(:renwujieduan)
        header_row[12] = l(:shijiandian)
        header_row[13] = l(:beizhu)
        ...
        @issues.each do |issue|
          ...
          if @query.name==l(:renwudabiao)
            ...
            if temp_id == cus_column_content(columns[0], issue)
                 n=3
            end
            temp_id = cus_column_content(columns[0], issue)
